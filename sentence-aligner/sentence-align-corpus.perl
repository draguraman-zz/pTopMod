...
binmode(STDOUT, ":utf8");
binmode(STDERR, ":utf8");
$Bin="/home/pratik/Dropbox/cs512";
chdir($Bin);
my $dir = "/home/pratik/Dropbox/cs512/allLangFiles_foraligned";
my $outdir = "aligned";
my $preprocessor = "$Bin/sentence-aligner/tools/split-sentences.perl -q";
